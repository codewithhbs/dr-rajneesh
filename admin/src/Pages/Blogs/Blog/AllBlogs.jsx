...
const BlogManagement = () => {
  ...
  const { categories, error: fetchError, refetch, loading: fetchLoading } = useBlogCategories()
      ...
      extraButtons: [
        {
          ...
          exec: (editor) => {
            ...
            const className = prompt("Enter Tailwind CSS classes:", selectedElement.className || "")
            if (className !== null) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedBlog) {
        await axiosInstance.put(`/update-blog/${selectedBlog._id}`, formDataToSend, config)
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Create, manage, and publish your blog content</p>
        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <Tabs defaultValue="content" className="w-full">
                        ...
                        <TabsContent value="content" className="space-y-6">
                          ...
                          <div>
                            <Label className="text-sm font-medium mb-3 block">Blog Content *</Label>
                            ...
                            <div>
                              ...
                              >
                                <SelectTrigger className="mt-1">
                                  <SelectValue placeholder={fetchLoading ? "Loading..." : "Select category"} />
                                </SelectTrigger>
                                <SelectContent>
                                  {categories && categories.length > 0 ? (
                                    categories.map((category) => (
                                      <SelectItem key={category._id || category.name} value={category._id || category}>
                      ...
                      <div className="flex justify-end space-x-3 pt-6 border-t">
                        ...
                        <Button type="submit" disabled={loading} className="bg-blue-600 hover:bg-blue-700">
                          {loading ? (
                            ...
                            <>
                              {selectedBlog ? <Edit className="h-4 w-4 mr-2" /> : <Plus className="h-4 w-4 mr-2" />}
            ...
            {fetchError && (
              <Alert className="m-6 border-orange-200 bg-orange-50">
                ...
                <AlertDescription className="text-orange-800">
                  Failed to load categories. You can still manage blogs, but category selection may be limited.
                </AlertDescription>
              </Alert>
            )}
                  ...
                  {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center space-y-4">
                          ...
                          <div className="text-center">
                            <h3 className="text-lg font-medium text-gray-900 mb-2">
                              {searchTerm || statusFilter !== "all" ? "No blogs found" : "No blog posts yet"}
                            </h3>
                    ...
                    filteredBlogs.map((blog) => (
                      <TableRow key={blog._id} className="hover:bg-gray-50">
                        ...
                        <TableCell>
                          {blog.featured && (
                            <Badge className="bg-purple-100 text-purple-800 border-purple-200">Featured</Badge>
                          )}
                        </TableCell>
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end space-x-1">
                            ...
                            <Button size="sm" variant="ghost" onClick={() => handleEdit(blog)} className="h-8 w-8 p-0">
            ...
            {viewBlog && (
              <div className="space-y-6">
                <div className="border-b pb-4">
                  <h1 className="text-3xl font-bold text-gray-900 mb-2">{viewBlog.title}</h1>
                  <p className="text-gray-600">Slug: /{viewBlog.slug}</p>
                  <div className="flex flex-wrap gap-2 mt-3">
                    <Badge className={getStatusColor(viewBlog.status)}>{viewBlog.status}</Badge>
                    {viewBlog.featured && (
                      <Badge className="bg-purple-100 text-purple-800 border-purple-200">Featured</Badge>
                    )}
                    {viewBlog.category && (
