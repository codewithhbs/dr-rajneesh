...
const AllBlogCategories = () => {
    ...
    const handleSubmit = useCallback(async () => {
        ...
        try {
            ...
            if (isEditMode) {
                await axiosInstance.put(`/update-category/${editingCategory._id}`, payload);
            } else {
                                        ...
                                        <td className="p-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-xs text-gray-500">ID: {category._id?.slice(-6)}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="p-4">
                ...
                <DialogContent className="max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            This action cannot be undone and may affect associated blog posts.
                        </DialogDescription>
                    </DialogHeader>
