    ...
    return (
        <>
            ...
            <section className="max-w-4xl mx-auto px-4 py-8 text-gray-800">
                ...
                <p className="mb-4">
                    At <strong>Dr. Rajneesh Kant Clinic</strong>, your privacy is our priority. Located in Mumbai & Patna, we are a top-rated establishment in the field of Orthopedic care, servicing patients both locally and from other parts of the city.
                </p>
