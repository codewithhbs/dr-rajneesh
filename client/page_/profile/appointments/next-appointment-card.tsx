            ...
            <div className="flex-1 space-y-4">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-semibold text-slate-800">
                  {
                    nextAppointment.booking.session_booking_for_doctor
                      .doctor_name
                  }
                </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-center text-slate-700 bg-slate-50 rounded-md px-4 py-2 col-span-full">
                  ...
                  <span className="text-sm font-medium truncate">
                    {
                      nextAppointment.booking.session_booking_for_clinic
                        .clinic_name
                    }
                  </span>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <Link href={`/pages/view-booking-details/${nextAppointment?.booking?._id}`} className="w-full sm:w-auto">
                  <Button
                    className="bg-linear-to-r from-[#155DFC] to-[#0092B8]
                 border border-[#155DFC] w-full sm:w-auto"
                  >
                    View Details
                  </Button>
                </Link>
