      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Welcome to Back To Dr. Rajneesh Kant Clinic - Your trusted partner in comprehensive spine and musculoskeletal
            health care
          </p>
        </div>
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed mb-6">
                    Dr. Rajneesh Kant in Mumbai is a top player in the category of Orthopedic Doctors in Mumbai. This
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed mb-8">
                    ...
                    collaboratively towards achieving the company's vision and goals. Looking ahead, we are excited to
                    expand our offerings and reach an even broader audience.
                  </p>

                  <div className="flex gap-4 flex-wrap">
                    <Button className="bg-gradient-to-r from-blue-500 to-purple-500 text-white border-0 hover:shadow-xl transform hover:scale-105 transition-all duration-300 px-6 py-3">
                      <Calendar className="w-5 h-5 mr-2" />
                      Book Appointment
                    </Button>
                    <Button
                      variant="outline"
                      className="border-gray-300 text-gray-700 hover:bg-gray-50 px-6 py-3 shadow-md"
                    >
                  ...
                  <div className="aspect-square bg-gradient-to-br from-blue-100 to-purple-100 rounded-2xl flex items-center justify-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 text-center">
                      <div className="w-24 h-24 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-xl">
                        <Stethoscope className="md:w-12 md:h-12 text-white" />
                      </div>
              ...
              <div className="grid md:grid-cols-2 text-center md:text-start gap-8 lg:gap-12">
                <div>
                  ...
                  <div className="flex items-center gap-2 text-gray-600 mb-2">
                    ...
                    <span>Mumbai & Mumbai Locations</span>
                  </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              <Card
                key={index}
                className="group bg-white/80 backdrop-blur-sm border border-gray-200 rounded-2xl overflow-hidden hover:border-gray-400 transition-all duration-500 cursor-pointer hover:-translate-y-2 hover:shadow-2xl"
              >
        ...
        {/* Achievements */}
        <div className="mb-16">
          <Card className="bg-gradient-to-r from-blue-300 to-purple-500 text-white rounded-3xl overflow-hidden shadow-sm">
            <CardContent className="p-8 sm:p-12">
              <div className="text-center mb-8">
  ...
  <Card className="bg-white/90 backdrop-blur-xl border border-gray-200 rounded-3xl p-6 sm:p-10 shadow">
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
        <Button className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-purple-500 text-white border-0 hover:shadow-xl transform hover:scale-105 transition-all duration-300 px-6 py-3 text-sm sm:text-base">
          <Calendar className="w-4 h-4 mr-2" />
          Schedule Consultation
        </Button>
        <Button
          variant="outline"
          className="w-full sm:w-auto border-gray-300 text-gray-700 hover:bg-gray-50 px-6 py-3 text-sm sm:text-base shadow-md"
        >
